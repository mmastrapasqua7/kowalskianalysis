...
% prove per un draft più leggibile
...
\begin{document}
	...
	}\todo{atrent: esatto, ci vorrà una bella sezione ``state of the art''}\todo{atrent: formalizzazione sicuramente, così (sotto) è in forma di ``appunti interni''}
	\linebreak
	...
	}\todo{atrent: attenzione allo spelling}\todo{atrent: perché il large?}
	...
	}\todo{atrent: in generale va usato l'impersonale}\todo{atrent: maggior precisione sulle domande che ti poni, ad es. vuoi confrontare prezzi, tempi, ``scomodità'' ecc. cioè quali sono i fattori che vuoi ``mettere in tabella''?}
	...
	{\large
		...
		\end{itemize}
	}\todo{atrent: citare lavoro di Federico}
