...
\begin{itemize}
	...
	\item a piedi.
\end{itemize}
Sebbene il servizio di car sharing riguardi comunque l'utilizzo di un'automobile, l'uso di tale servizio è in grado di abbattere due dei problemi principali dell'auto: il primo è il costo, che viene ridotto al solo\todo{atrent: guarda che il carsharing costa MOLTO DI PIU' al km rispetto ad un'auto privata, attento a non dire cose false!!! il costo annuo potrebbe essere inferiore SOLO se l'auto privata si usa poco, ma chi la usa molto NON ha convenienza a usare il carsharing, ATTENTO!!!} utilizzo e a una quota di iscrizione; il secondo è l'inquinamento, dal momento che il parco auto offerto è di ultima generazione\todo{atrent: sicuro?!? hai un ref bib che racconti il parco auto del car sharing? soprattutto in confronto al parco auto generalmente circolante?}, quindi conforme agli ultimi standard sulle emissioni. In alcuni casi, come per Sharengo, il parco auto offerto è completamente elettrico. Il percorso a piedi, seppur non diretto competitore, è stato scelto per essere usato come riferimento.
...
\todo{atrent: mi piacerebbe tu citassi il lavoro di Losacco e motivassi perché hai deciso di non usare le tratte reali scraped}
