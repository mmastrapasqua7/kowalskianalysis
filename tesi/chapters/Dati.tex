...
Avendo l'accesso ai dati storici in possesso da queste aziende, il confronto si sarebbe potuto effettuare in diversi modi. Un possibile approccio sarebbe stato quello di clusterizzare, per ognuno dei dataset corrispondenti a un mezzo di trasporto diverso, i punti di partenza e di destinazione di ogni tratt...
