...
\begin{figure}[H]
	\includegraphics[scale=0.8]{vmedia_atm_weeks}
	\caption{Frequenza relativa vittorie bicicletta su Enjoy di ora in ora}
	\label{image:29}
\end{figure}
...
\begin{figure}[H]
	\includegraphics[scale=0.7]{vmedia_oraria_auto_prepostlock_week}
...
\begin{figure}[H]
	\includegraphics[scale=0.7]{vmedia_oraria_enjoy_prepostlock_week}
