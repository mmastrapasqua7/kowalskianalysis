...
\begin{table}[H]
	...
	\label{table:2}
\end{table}\todo{atrent: le H mettile solo a posteriori, in prima battuta lascia che sia latex a posizionare le figure/tabelle}
...
\todo{atrent: ci starebbe anche uno split  per classi di lunghezza-tratta, magari c'è dopo}
\begin{figure}[!h]
