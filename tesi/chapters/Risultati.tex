...
\label{table:1}
\end{table}\todo{atrent: dai nomi semantici nelle caption!!! (vale dappertutto)}
...
In questo paragrafo sono stati raccolti i risultati più interessanti emersi dal confronto tra tutti i mezzi di trasporto a disposizione per spostarsi nel Comune di Milano. Il confronto più atteso che ha fatto da guida verso questo studio è stato quello di verificare se un mezzo altamente costoso e inquinante\todo{atrent: "inquinante" è tutto da dimostrare, o metti delle ref o non lo accetto, oggi le auto di fatto NON hanno più alcun effetto pratico sull'aria} come le auto a gasolio e benzina potessero essere surclassate da un mezzo più economico e pulito come i mezzi pubblici in una città dove il traffico influisce pesantemente sui tempi di percorrenza, come mostrato nel grafico \ref{image:3}.\todo{atrent: veramente io vedo in quella figura che la vel media non cambia molto nell'arco della giornata, quindi dimostra esattamente il contrario!!!}

\subsection{Vittoria dell'automobile}

Contro ogni aspettativa\todo{atrent: contro ogni TUA aspettativa ;) io me lo aspettavo e mi sarei MOLTO insospettito se fosse risultato il contrario}, nonostante la grande influenza del traffico sui tempi di percorrenza, i tragitti in auto sono risultati sempre i più veloci di ogni sua controparte, a qualsiasi ora del giorno e su ogni distanza, con una vittoria sopra il 99\% delle volte.
