...
\begin{figure}[H]
	...
	\caption{Velocità media usando il car sharing Enjoy [km/h] di ora in ora. Ingrandimento sull'asse delle ordinate ai valori 12 di minimo e 21 di massimo}
	\label{image:20}
\end{figure}

Non sono state registrate particolari differenze effettuando la ripartizione dei dati in base ai giorni intrasettimanali e del fine settimana, come mostrato nella figura \ref{image:20}. La velocità media rimane costante, con una lieve differenza nella fascia oraria delle 8:00. La deviazione standard, rimane costante e identica a quella del grafico \ref{image:7} per tutte le fasce di orario.

\subsubsection{Velocità media settimana dopo settimana da fine lockdown}

\begin{figure}[H]
	\includegraphics[scale=0.8]{vmedia_oraria_enjoy_weeks}
	\caption{Velocità media in car sharing Enjoy [km/h] di ora in ora. Ingrandimento sull'asse delle ordinate ai valori 12 di minimo e 21 di massimo}
	\label{image:16}
\end{figure}
...
\begin{figure}[H]
\includegraphics[scale=0.9]{confronto_bike_enjoy}
