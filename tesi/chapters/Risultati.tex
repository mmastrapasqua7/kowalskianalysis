...
Nella tabella \ref{table:2} e figura \ref{image:2} sono riportate le statistiche riguardo la lunghezza in via aerea delle tratte generate. Si può vedere come più della metà sia lunga meno di 5 km in linea aerea, risultato ottenuto in parte dai constraint imposti nella generazione.
...
\subsection{Servizio di car sharing Enjoy}
